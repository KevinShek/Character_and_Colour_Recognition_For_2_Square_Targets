...
class Settings:
    ...
    rel_path = "Test_Images/92_5.png"  # where is the image is located from where the config is
    # current located
    ...
    preprocess_color = "temperature_colour"  # the pre processing on normalising the colour by the use of character as an
    ...
    Classifications = npaClassifications.reshape((npaClassifications.size, 1))
