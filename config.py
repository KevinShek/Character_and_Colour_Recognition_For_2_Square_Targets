...
class Settings:
    ...
    rel_path = "Test_Images/resolution/8M/3.5/4_3.5_8m.png"  # where is the image is located from where the config is
    # current located
