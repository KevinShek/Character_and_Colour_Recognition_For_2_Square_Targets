...
class Settings:
    def __init__(self):
        ...
        self.Step_camera = True  # stages of camera activating
        ...
        self.exist_ok = True # it would save the content into the same name of folder if it exist within result_dir
        ...
        self.testing = ""  # are you running the program for a "video" to use this capture has to be "pc" or "pi"
